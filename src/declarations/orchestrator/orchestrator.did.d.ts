...
export interface CkNFTCanisterStateShared {
  ...
  'lastCycles' : bigint,
  'network' : Network__1,
  'networkMap' : Array<[Network__1, Contract]>,
...
export interface ContractPointer__1 { 'contract' : string, 'network' : Network }
...
export interface ContractStateShared__1 {
  'nextQuery' : [] | [bigint],
  'contractType' : { 'Remote' : null } |
    { 'Owned' : ContractPointer },
  'network' : [] | [Network],
...
export type Network__1 = { 'IC' : [] | [string] } |
  ...
  { 'Bitcoin' : [] | [string] } |
  { 'Other' : ICRC16Map };
export type Network__2 = { 'IC' : [] | [string] } |
  { 'Ethereum' : [] | [bigint] } |
  { 'Solana' : [] | [bigint] } |
  { 'Bitcoin' : [] | [string] } |
  { 'Other' : ICRC16Map };
export interface OrchestratorActor {
  ...
  >,
  'forceCkNFTCaniser' : ActorMethod<[ContractPointer__1, Principal], undefined>,
  ...
  'get_remote' : ActorMethod<
    [Array<[Principal, Network__2]>],
    Array<[] | [ContractStateShared__1]>
  >,
  ...
  'get_remote_meta' : ActorMethod<
    [Array<RemoteNFTPointer>, Array<bigint>, [] | [Account__1]],
    Array<[] | [GetCallResult]>
  >,
  'get_remote_owner' : ActorMethod<
    [Array<RemoteNFTPointer>, [] | [Account__1]],
    Array<[] | [GetCallResult]>
  >,
...
export type SolonaRPCService = { 'Generic' : RpcApi };
